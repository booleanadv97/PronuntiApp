...
class ImageAnswersGridViewAdapter(private val context: Context,
                                  private val answers: List<ImageAnswer>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): ImageAnswer {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val rowView = inflater.inflate(R.layout.image_answer_gridview_item, parent, false)
        val answer : ImageAnswer = getItem(position)
